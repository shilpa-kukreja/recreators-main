...
export default function VideoCallRoom() {
  ...
  // ✅ use room.waiting instead of a never-populated local state
  ...
  const handleLeave = () => {
    ...
    navigate.push('/video-call/meeting-ended'); // ✅ fixed
  };
          ...
          >
            ...
            <dl className="!space-y-2.5 !text-sm">
              {[
                ...
                ['Link', room.meeting?.meetingId && typeof window !== 'undefined'
                  ? `${window.location.origin}/video-call/${room.meeting.meetingId}`
                  : '—'],
              ].map(([k, v]) => (
