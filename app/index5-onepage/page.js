...
const page = () => {
  const menus = [
    ...
    { id: 4, text: "Why Choose", href: "#why-choose" },
    { id: 5, text: "Pricing", href: "#pricing" },
    { id: 6, text: "Testimonials", href: "#testimonials" },
    { id: 7, text: "Blog", href: "#blog" },
  ];

  return (
    <RiddaLayout bodyClass="home-five" header={5} footer={5} menus={menus}>
      {/* Hero Area Start */}
      <section
        id="home"
        ...
        <div className="container container-1290">
          ...
          <div className="row justify-content-center text-center">
            ...
            <div className="col-xl-4 col-md-6" data-aos="flip-up">
              ...
              >
                <div className="icon">
                  <i className="flaticon-online-shopping" />
                </div>
                <h4>
      ...
      <section
        id="why-choose"
        className="why-choose-us-five-area rel z-1 pt-130 rpt-100 pb-80"
      >
        <div className="container container-1290">
        ...
        <div className="container container-1290">
          ...
          <div className="row no-gap justify-content-center">
            <div className="col-xl-6 col-lg-8">
              <div
                className="blog-item style-four"
                data-aos="fade-up"
                data-aos-duration={1500}
                data-aos-offset={50}
              >
            ...
            <div className="col-xl-6 col-lg-8">
              <div
                className="blog-item style-four image-left"
                data-aos="fade-up"
                data-aos-duration={1500}
                data-aos-offset={50}
              >
