    ...
    >
        ...
        <div className="container container-1290">
          <div className="row align-items-center">
            <div className="col-xl-10">
              ...
              >
                <h1>
                  Transform Your Brand with Powerful Video Marketing
                </h1>
      ...
      >
        <div className="container container-1290">
          ...
          >
            <img
              src="/assets/images/video/video-bg.jpg"
              alt="Video"
            />
            ...
            >
              <div className="about-three-content rmb-55">
                <div className="section-title mb-30">
                  ...
                  <h2>
                    Welcome Ridda Video Marketing Agency to grow your
                    business
                  </h2>
                </div>

                <p>
                  Understanding your marketing videos&apos; performance can
                  be like looking for a needle in a haystack. Vidyard&apos;s
                  online video marketing platform is a magnet for your
                  needle.
                </p>
              ...
              <div className="service-item style-four">
                ...
                <div className="content">
                  ...
                  <p>
                    ...
                    engaging and impactful video content that communicates
                    a brand&apos;s message.
                  </p>
                </div>
              </div>
              ...
              <div className="service-item style-four">
                ...
                <div className="content">
                  ...
                  <p>
                    ...
                    that leverages video content to achieve specific
                    business goals.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="service-item style-four">
                ...
                <div className="content">
                  ...
                  <p>
                    Animation and motion graphics are dynamic visual
                    elements that bring static designs to life, making them
                    more engaging.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="service-item style-four">
                ...
                <div className="content">
                  ...
                  <p>
                    Live streaming services enable businesses and
                    individuals to broadcast events, webinars, product
                    launches, or other content.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-5 col-lg-6 text-white">
              <div className="why-choose-left py-100 d-flex flex-column h-100 align-items-start">
                <div className="section-title mb-45">
                  ...
                  <h2>
                    Why People Choose Our Ridda Agency Service
                  </h2>
                </div>

                <div className="text mt-auto">
                  Video marketing has become a powerful tool for businesses
                  to connect with their audience in a more engaging and
                  memorable way. Through the visual and auditory elements of
                  video, companies can communicate their message
                  effectively.
                </div>
            ...
            <div className="col-xl-5 col-lg-6">
              ...
              >
                <div className="section-title mb-30">
                  ...
                  <p>
                    Contact us today to schedule a consultation or learn
