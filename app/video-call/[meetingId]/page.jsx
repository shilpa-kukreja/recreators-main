...
const LOGO = process.env.NEXT_PUBLIC_COMPANY_LOGO_URL || '/assets/images/logos/RCLogo.png';
...
function JoinVideoCallContent() {
  ...
  const resolveAndLoad = async () => {
    ...
    try {
      ...
      router.replace(`/video-call/${data.meeting.meetingId}`);
      setStep('form');
    } catch (err) {
  ...
  const handleJoinWithDevice = async () => {
    ...
    try {
      ...
      router.replace(`/video-call/${meeting.meetingId}/room`);
    } catch (err) {
